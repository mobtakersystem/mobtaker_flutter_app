...
import 'package:mpm/data/entities/dashboard_chart/enventory_chart_entity.dart' show InventoryChartEntity;
...
class InventoryChart extends _$InventoryChart {
  ...
  FutureOr<ResultData<InventoryChartEntity>> build() async {
    return GetIt.I<InventoryDataDashboardChartUseCase>().call();
  }
}
